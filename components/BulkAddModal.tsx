        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6">
              <div className="flex justify-between items-baseline mb-1">
                <label htmlFor="json-content" className="block text-sm font-medium text-gray-600 dark:text-gray-300">
                  Paste an array of {deckType === DeckType.Flashcard ? 'card' : 'question'} objects
                </label>
                <Link href="/instructions/json" onClick={onClose} className="text-sm text-blue-500 dark:text-blue-400 hover:underline inline-flex items-center gap-1">
              ...
              <textarea
                ...
                rows={15}
                className="w-full p-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none font-mono text-sm"
