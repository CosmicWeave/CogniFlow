      ...
      <div ref={modalRef} className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg transform transition-all relative">
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 space-y-4">
            <div>
              <label htmlFor="series-name" className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Series Name</label>
              <input
                id="series-name"
                type="text"
                value={name}
            ...
            <div>
              <label htmlFor="series-description" className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Description</label>
              <textarea
