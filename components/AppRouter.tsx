...
const AppRouter: React.FC<AppRouterProps> = (props) => {
    ...
    const renderPage = () => {
            ...
            if (!activeDeck) {
                return (
                    <div className="text-center py-20">
                      <h2 className="text-3xl font-bold text-gray-600 dark:text-gray-400">Deck Not Found</h2>
                      <p className="mt-4 text-gray-500 dark:text-gray-500">The deck you are trying to study does not exist.</p>
                    </div>
                );
            }
        ...
        if (pathname.startsWith('/decks/') && pathname.endsWith('/study-flip')) {
            ...
            if (activeDeck.type === 'quiz' || activeDeck.type === 'learning') {
